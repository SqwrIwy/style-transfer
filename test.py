...
def style_transfer_mask(vgg, decoder, content, mask, style1, style2, alpha=1.0,
    ...
    feat = feat1 * mask.expand_as(feat1) + content_f - content_f * mask.expand_as(feat2)
    feat = feat * alpha + content_f * (1 - alpha)
    return decoder(feat)
...
parser.add_argument('--mask', type=str, default='', help='')
parser.add_argument('--style2', type=str, default='', help='')
